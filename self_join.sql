...
-- 5.
-- Execute the self join shown and observe that b.
-- stop gives all the places you can get to from Craiglockhart, without changing routes. 
...
ORDER BY LENGTH(a.num), b.num, stopb.id, LENGTH(c.num), d.